...
--
-- Table structure for table `profile`,`address`
--
...
CREATE TABLE `address` (
  ...
  `profile_id` int(11)  CHARACTER SET utf8 DEFAULT NULL,
  `addr_type` varchar(512) CHARACTER SET utf8 DEFAULT NULL,
  `address` varchar(2400) CHARACTER SET utf8 DEFAULT NULL,
